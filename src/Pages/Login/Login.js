...
const Login = () => {
    const { providerLogin, login, errorMsgToast } = useContext(AuthContext);
    ...
    return (
        <div className="hero min-h-screen" style={{ backgroundImage: `url("https://i.ibb.co/S5Zsd9v/pexels-mathew-thomas-906531.jpg")` }}>
            ...
            <div className="hero-content text-center text-neutral-content grid md:grid-cols-2 flex-col lg:flex-row">
                <div className="text-center lg:text-left">
                    ...
                    <p className="py-6">Please enter your details and login to continue. </p>
                </div>
                <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100 py-12 border-8 border-dark mt-12">
                    ...
                    <p className='text-center label-text'>New to Reflexlia? <Link to="/signup" className='font-bold'>Sign Up</Link></p>
                    <div>
